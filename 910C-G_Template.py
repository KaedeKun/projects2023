...
while True:
    try:
        ...
        print(Fore.RED+'Ingrese rango IP Valido')
        continue
...
#--------------------------------------------------------------------------------------------
# SEGMENTACION Direccionamiento BBUs 910C ( O&M + Servicios )
BBUContador = 1
baseBBUDir = list(baseBBUDir.subnet(30))[0:8]
with open('opt/910_direcciones_raw_bbu.txt','w+',encoding='utf-8') as final_dirbbu:
...
#-----------------------------------------------------------------------------
e = open('opt/910_direcciones_raw_bbu.txt', 'r')
lines = e.readlines()
# # #-----------------------------------------------------------------------------
BBU1 = lines[0]
...
# #--------------------------------------------------------------------------------------------------------------------------
with pd.ExcelWriter('opt/910_Excel_BaseDatos_BBUs_Eth.xlsx', mode='a', engine='openpyxl', if_sheet_exists='overlay') as writer:
#with pd.ExcelWriter('opt/910_Excel_BaseDatos_BBUs.xlsx', mode='a', engine='openpyxl', if_sheet_exists='overlay') as writer:     
...
mostrar = pd.DataFrame(pd.read_excel('opt/910_Excel_BaseDatos_BBUs_Eth.xlsx'))
#mostrar = pd.DataFrame(pd.read_excel('opt/910_Excel_BaseDatos_BBUs.xlsx'))
mostrar.to_csv('opt/910_BD_BBUs.csv', index=None, header=True, decimal='')
tranformacion_excel = pd.DataFrame(pd.read_csv('opt/910_BD_BBUs.csv'))
# #------------------------------------------------------------------------------
# MANIPULACION JINJA2 TEMPLATE + SOURCE FILE

source_file = 'opt/910_BD_BBUs.csv'
BBU_Template_file ='templates/final_template_jinja_interfaces_910_bbu_eth_csv.j2'
#BBU_Template_file ='templates/final_template_jinja_interfaces_910_bbu_csv.j2'
...
with open(f'910C-G_BBU_CONFIG_FINAL_{nombre_router}.txt','w') as lectura:
...
with open('opt/910_direcciones_raw_RTNOyM.txt','w+',encoding='utf-8') as dir_rtn_oym:
...
#-----------------------------------------------------------------------------
lect_rtnOyM = open('opt/910_direcciones_raw_RTNOyM.txt', 'r')
...
with open('opt/910_direcciones_raw_RTNServ.txt','w+',encoding='utf-8') as dir_rtn_serv:
...
#-----------------------------------------------------------------------------
lect_rtnServ = open('opt/910_direcciones_raw_RTNServ.txt', 'r')
...
if rango_vlans == '101-129' or rango_vlans == '':
        with pd.ExcelWriter('opt/910_Excel_BaseDatos_RTNs_IF_SERVICE_NEW_ALL27.xlsx', mode='a', engine='openpyxl', if_sheet_exists='overlay') as writer:
        ...
        mostrarRTN = pd.DataFrame(pd.read_excel('opt/910_Excel_BaseDatos_RTNs_IF_SERVICE_NEW_ALL27.xlsx'))
        mostrarRTN.to_csv('opt/910_BD_RTNs.csv', index=None, header=True)
        tranformacion_excel_RTN = pd.DataFrame(pd.read_csv('opt/910_BD_RTNs.csv'))
else:
        with pd.ExcelWriter('opt/910_Excel_BaseDatos_RTNs_IF_SERVICE_LAST28.xlsx', mode='a', engine='openpyxl', if_sheet_exists='overlay') as writer:
            pd.DataFrame([RTN01_OyM]).to_excel      (writer, sheet_name='Excel_BaseDatos_RTN', startcol=4, startrow=2, index=False, header=False)
            pd.DataFrame([RTN01_OyM1]).to_excel     (writer, sheet_name='Excel_BaseDatos_RTN', startcol=4, startrow=3, index=False, header=False)
            pd.DataFrame([RTN01_IuB]).to_excel      (writer, sheet_name='Excel_BaseDatos_RTN', startcol=4, startrow=4, index=False, header=False)
            pd.DataFrame([RTN01_s1]).to_excel       (writer, sheet_name='Excel_BaseDatos_RTN', startcol=4, startrow=5, index=False, header=False)
        ...
        mostrarRTN = pd.DataFrame(pd.read_excel('opt/910_Excel_BaseDatos_RTNs_IF_SERVICE_LAST28.xlsx'))
        mostrarRTN.to_csv('opt/910_BD_RTNs.csv', index=None, header=True)
        tranformacion_excel_RTN = pd.DataFrame(pd.read_csv('opt/910_BD_RTNs.csv'))
...
source_file_RTN = 'opt/910_BD_RTNs.csv'
...
with open(f'910C-G_RTN_CONFIG_FINAL_{nombre_router}.txt','w') as lectura_rtn:
